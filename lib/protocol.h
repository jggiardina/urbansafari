...
typedef enum  {
  ...
  PROTO_MT_REQ_BASE_TAKE_HAMMER,
  PROTO_MT_REQ_BASE_TAKE_FLAG,
  PROTO_MT_REQ_BASE_DROP_FLAG,
  PROTO_MT_REQ_BASE_MAP_DIM,
  PROTO_MT_REQ_BASE_MAP_DUMP,
  PROTO_MT_REQ_BASE_MAP_INFO_1,
  PROTO_MT_REQ_BASE_MAP_INFO_2,
  PROTO_MT_REQ_BASE_MAP_INFO,
  PROTO_MT_REQ_BASE_MAP_CINFO,
  ...
  PROTO_MT_REP_BASE_TAKE_HAMMER,
  PROTO_MT_REP_BASE_TAKE_FLAG,
  PROTO_MT_REP_BASE_DROP_FLAG,
  PROTO_MT_REP_BASE_MAP_DIM,
  PROTO_MT_REP_BASE_MAP_DUMP,
  PROTO_MT_REP_BASE_MAP_INFO_1,
  PROTO_MT_REP_BASE_MAP_INFO_2,
  PROTO_MT_REP_BASE_MAP_INFO,
  PROTO_MT_REP_BASE_MAP_CINFO,
  ...
  PROTO_MT_EVENT_BASE_WINNER,
  PROTO_MT_EVENT_BASE_HELLO,
  PROTO_MT_EVENT_BASE_MOVE,
  PROTO_MT_EVENT_BASE_GOODBYE,
