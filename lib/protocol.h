...
typedef enum  {
  ...
  PROTO_MT_REQ_BASE_CONNECT,
  PROTO_MT_REQ_BASE_DISCONNECT,
  PROTO_MT_REQ_BASE_MOVE,
  PROTO_MT_REQ_BASE_PRINT,
  ...
  PROTO_MT_REP_BASE_CONNECT,
  PROTO_MT_REP_BASE_DISCONNECT,
  PROTO_MT_REP_BASE_MOVE,
  PROTO_MT_REP_BASE_GOODBYE,
  PROTO_MT_REP_BASE_INVALID_MOVE,
  PROTO_MT_REP_BASE_NOT_TURN,
  PROTO_MT_REP_BASE_NOT_STARTED,
  PROTO_MT_REP_BASE_PRINT,
  ...
  PROTO_MT_EVENT_BASE_WIN,
  PROTO_MT_EVENT_BASE_DRAW,
